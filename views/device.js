...
exports.reference = (link, token, a, b) => {
    let body = `
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td valign="top" mc:edit="headerBrand" id="templateContainerHeader">
					...
					<p style="text-align:center;margin:0;padding:0;">
						<img src="${env.backend + a +'.gif'}" style="display:inline-block;" />
					</p>
      ...
      <tr>
				<td align="center" valign="top">
                  ...
                  <h3>Hello!</h3>
									<h2><strong>New Device Login</strong></h2>
									<p>
									You are required to enter this OTP (one time password) to add your new device successfully.
							
									<br>
									The OTP may expire in 5 days.
									</p>									
								</td>
							</tr>
						</table>
      ...
      <tr>
				<td align="center" valign="top">
                  ...
                  <a class="blue-btn"><strong>${token}</strong></a>
								</td>
							</tr>
						</table>
						<!-- // END BODY -->
						...
						<tr>
							<td valign="top" width="100%" mc:edit="footer_unsubscribe">
								<p style="text-align:center;">
									<img src="${env.backend + b + '.gif'}" style="margin:0 auto 0 auto;display:inline-block;" />
								</p>
