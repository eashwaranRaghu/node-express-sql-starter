...
exports.reference = (name, total, note, link, site, a, b) => {
    let table  = (note) => {
        let str = '';
        for (var key in note) {
      ...
      <tr>
				<td align="center" valign="top">
                  ...
                  <h3>Hello ${name},</h3>
									...
									<p>
									You have <strong>${total}</strong> notifications. Please visit <a href="https://hrmsfirst.com/">hrmsfirst.com</a></h6> to see them.
									</p>									
								</td>
							</tr>
						</table>
      ...
      <tr>
				<td align="center" valign="top">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
							<tr>
								<td valign="top" class="bodyContentCenter" mc:edit="body_content_centered">
                  <a class="blue-btn" href="${link}"><strong>Go to ${site}</strong></a>
								</td>
							</tr>
						</table>
						<!-- // END BODY -->
