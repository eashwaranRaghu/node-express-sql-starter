...
exports.reference = (candidate, link) => {
    let body = `
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td valign="top" mc:edit="headerBrand" id="templateContainerHeader">
					...
					<p style="text-align:center;margin:0;padding:0;">
						<img src="${env.backend + 'HF1.gif'}" style="display:inline-block;" />
					</p>
      ...
      <tr>
				<td align="center" valign="top">
                  ...
                  <h3>Hello!</h3>
									<h2><strong><b>${candidate.name}</b> with email ${candidate.email} has asked for your reference for a job.</strong></h2>
									<p>You reference will aid the HR team in the hiring process<br /><br /> To refer, please visit the link below. Ignore otherwise.</p>
								</td>
							</tr>
						</table>
						<!-- // END BODY -->
      ...
      <tr>
				<td align="center" valign="top">
                  ...
                  <a class="blue-btn" href="${link}"><strong>Refer</strong></a>
								</td>
							</tr>
						</table>
						<!-- // END BODY -->
						...
						<tr>
							<td valign="top" width="100%" mc:edit="footer_unsubscribe">
								<p style="text-align:center;">
									<img src="${env.backend + 'HF2.gif'}" style="margin:0 auto 0 auto;display:inline-block;" />
								</p>
								<h6 style="text-align:center;margin-top: 9px;">HRMS FIRST</h6>
								<h6 style="text-align:center;"><a href="https://hrmsfirst.com/">hrmsfirst.com</a></h6>
								<h6 style="text-align:center;"> Securely connect, sync, and collaborate.
                                                              Designed to take teamwork to the next level.
                                                              Space for sharing and collaboration.
                                                              Advanced security features.
                                                              Dedicated live support.
                                                              Get all the features your business needs.</h6>
							</td>
						</tr>
					</table>
				</td>
